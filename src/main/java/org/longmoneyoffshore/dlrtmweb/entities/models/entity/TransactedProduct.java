...
/*
    ...
    public TransactedProduct(
            ...
            String productUniqueID, String productName, String productManufacturer, String productCountryOfOrigin,
            String productDescription, double productUnitPurchasePrice, double productUnitPrice, double productDiscounts, double productAdjustments,
            double productCredits, double productDeductions, String productSpecialOffers, String currency, int productItemsInStockInt,
            float productItemsInStockDecimal, float productQuantityInStock, int productNeedToReorder, String productMeasurementUnit,
            String productSpecialMentions, int productTransactedUnits, double productTransactedUnitsDecimal, double productTransactedQuantity,
        ...
        super(productUniqueID, productName, productManufacturer, productCountryOfOrigin, productDescription, productUnitPurchasePrice, productUnitPrice,
                productDiscounts, productAdjustments, productCredits, productDeductions, productSpecialOffers,currency, productItemsInStockInt,
                productItemsInStockDecimal, productQuantityInStock, productNeedToReorder, productMeasurementUnit, productSpecialMentions);
